/// apiStatus : true
/// data : {"_id":"64146f07042c88ada34ece8c","name":"youssef mohamed","Isverified":true,"email":"yoseffmohamed001@gmail.com","isAdmin":false,"isDoctor":false,"Notification":[],"seenNotification":[],"RandomNumber":"3195","phone":1211829505,"uniqueString":9332,"createdAt":"2023-03-17T13:45:43.055Z","updatedAt":"2023-03-17T21:14:57.107Z"}
/// message : "password changed successfully"

class VerifyPassModel {
  VerifyPassModel({
      bool? apiStatus, 
      Data? data, 
      String? message,}){
  ...
  VerifyPassModel.fromJson(dynamic json) {
  ...
  Data? _data;
  String? _message;
VerifyPassModel copyWith({  bool? apiStatus,
  Data? data,
  String? message,
}) => VerifyPassModel(  apiStatus: apiStatus ?? _apiStatus,
  data: data ?? _data,
